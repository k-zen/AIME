...
public class LockUtil {
    ...
    public static final String GENERATOR_LOCK = "aime.generator.lock";
    public static final String FETCHER_LOCK = "aime.fetcher.lock";
    public static final String PARSING_LOCK = "aime.parsing.lock";
    public static final String UPDATE_DB_LOCK = "aime.updatedb.lock";
    public static final String INVERT_LINKS_LOCK = "aime.invertlinks.lock";
    public static final String INDEX_LOCK = "aime.indexing.lock";
     ...
     * @param accept   if true, and the target file exists, consider it valid.
     *                 If false and the target file exists, throw an
     *                 IOException.
     *
     * @throws IOException if accept is false, and the target file already
     *                     exists, or if it's a directory.
     */
     ...
     *
     * @return false, if the lock file doesn't exist. True, if it existed and
