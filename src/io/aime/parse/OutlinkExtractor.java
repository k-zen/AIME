...
/**
 * Extractor to extract {@link io.aime.parse.Outlink}s URLs from plain text
 * using Regular Expressions.
 *
 * @see <a
 * href="http://wiki.java.net/bin/view/Javapedia/RegularExpressions">Comparison
 * of different regexp-Implementations</a>
 * @see <a href="http://regex.info/java.html">Overview about Java Regexp
 * APIs</a>
...
public class OutlinkExtractor {
    ...
    private static final String KEY = OutlinkExtractor.class.getName();
    private static final Logger LOG = Logger.getLogger(KEY);
    /**
     * Regex pattern to get URLs within a plain text.
     *
     * @see <a
     * href="http://www.truerwords.net/articles/ut/urlactivation.html">http://www.truerwords.net/articles/ut/urlactivation.html</a>
     */
    ...
    /**
     * Extracts
     * <code>Outlink</code> from given plain text. Applying this method to
     * non-plain-text can result in extremely lengthy runtimes for parasitic
    ...
    /**
     * Extracts
     * <code>Outlink</code> from given plain text and adds anchor to the
     * extracted
     * <code>Outlink</code>s
     *
     * @param plainText the plain text from wich URLs should be extracted.
        ...
        try {
            ...
            while (matcher.contains(input, pattern)) {
                ...
                if (System.currentTimeMillis() - start >= 60000L) {
                    LOG.warn("Tiempo limite excedido para [getOutLinks].");
                    break;
                }
    ...
    private Outlink[] getOutlinksJakartaRegexpImpl(final String plainText) {
        throw new UnsupportedOperationException("Implementacion comentada. Descomente para utilizar.");
