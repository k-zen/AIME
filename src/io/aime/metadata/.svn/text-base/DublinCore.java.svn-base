...
public interface DublinCore {
     ...
     * resource.
     *
     * <p>Format may be used to determine the software, hardware or other
     ...
     * Internet Media Types [MIME] defining computer media formats).</p>
     */
     ...
     *
     * <p>Example formal identification systems include the Uniform Resource
     ...
     * resource.
     *
     * <p>Examples of a Contributor include a person, an organisation, or a
     ...
     *
     * <p>Examples of a Creator include a person, an organisation, or a service.
     ...
     *
     * <p>Typically, Date will be associated with the creation or availability
     * of the resource. Recommended best practice for encoding the date value is
     ...
     * free-text account of the content.</p>
     */
    public static final String DESCRIPTION = "description";
    /**
     * A language of the intellectual content of the resource.
     *
     * <p>Recommended best practice is to use RFC 3066 [RFC3066], which, in
     ...
     *
     * <p>Examples of a Publisher include a person, an organisation, or a
     ...
     *
     * <p>Recommended best practice is to reference the resource by means of a
     * string or number conforming to a formal identification system.</p>
     */
     ...
     * with respect to the resource.</p>
     */
    public static final String RIGHTS = "rights";
    /**
     * A reference to a resource from which the present resource is derived.
     *
     * <p>The present resource may be derived from the Source resource in whole
     ...
     * a value from a controlled vocabulary (for example, the DCMI Type
     * Vocabulary [DCMITYPE]). To describe the physical or digital manifestation
     * of the resource, use the Format element.</p>
     */
