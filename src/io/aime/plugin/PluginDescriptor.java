...
/**
 * The
 * <code>PluginDescriptor</code> provide access to all meta information of a
 * AIME-plugin, as well to the internationalizable resources and the plugin own
 * classloader. There are meta information about
 * <code>Plugin</code>,
 * <code>ExtensionPoint</code> and
 * <code>Extension</code>. To provide access to the meta data of a plugin via a
 * descriptor allow a lazy loading mechanism.
 * @author joa23
 */
public class PluginDescriptor {
    ...
    private static final String KEY = PluginDescriptor.class.getName();
    ...
    public PluginClassLoader getClassLoader() {
        ...
        /*
         * File file = new File ( getPluginPath () ); try { for ( File file2 :
         * file.listFiles () ) { if ( file2.getAbsolutePath ().endsWith (
         * "properties" ) ) { arrayList.add ( file2.getParentFile ().toURL () );
         * } } } catch ( MalformedURLException e ) { LOG.debug ( getPluginId ()
         * + " " + e.toString () ); }
         */
