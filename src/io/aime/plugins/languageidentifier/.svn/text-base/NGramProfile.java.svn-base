...
public class NGramProfile {
    ...
    private static final String KEY = NGramProfile.class.getName();
    private static final Logger LOG = Logger.getLogger(KEY);
    /**
     * The minimum length allowed for a ngram.
     */
    protected static final int ABSOLUTE_MIN_NGRAM_LENGTH = 1;
    /**
     * The maximum length allowed for a ngram.
     */
    protected static final int ABSOLUTE_MAX_NGRAM_LENGTH = 4;
    /**
     * The default min length of ngram
     */
    protected static final int DEFAULT_MIN_NGRAM_LENGTH = 3;
    /**
     * The default max length of ngram
     */
    protected static final int DEFAULT_MAX_NGRAM_LENGTH = 3;
    /**
     * The ngram profile file extension
     */
    protected static final String FILE_EXTENSION = "ngp";
    /**
     ...
     */
    private static final String SEP_CHARSEQ = new String(new char[]{SEPARATOR});
    /**
     * The profile's name
     */
    ...
    public void add(Token t) {
        this.add(new StringBuffer().append(SEPARATOR).append(t.term()).append(SEPARATOR));
    }
    ...
    public void analyze(StringBuilder text) {
        ...
        for (int i = 0; i < text.length(); i++) {
            ...
            if (Character.isLetter(c)) {
                this.add(word.append(c));
            }
            else {
                //found word boundary
                if (word.length() > 1) {
                    //we have a word!
                    this.add(word.append(SEPARATOR));
                    word.clear().append(SEPARATOR);
                }
            }
        }
    ...
    public List<NGramEntry> getSorted() {
        ...
        if (sorted == null) {
            sorted = new ArrayList<NGramEntry>(this.ngrams.values());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            LOG.error("Capturado -> " + e.getMessage());
        }
    }
